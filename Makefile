...
aggregate:
	$(PY) -m scripts.ms1_runner --subjects $(SUBJECTS) --datasets $(DATASETS) --seeds $(SEEDS) --policy $(POLICY) --tools random --out $(SMOKE_OUT) --aggregate $(SMOKE_CSV)
